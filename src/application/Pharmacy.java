...
public class Pharmacy {
	...
	public void AddSalesPerson(String name,String username,String password) throws InstantiationException, IllegalAccessException, ClassNotFoundException, IOException
	{
		
		manager.SaveSalesPerson(name,username,password);
	}
}
